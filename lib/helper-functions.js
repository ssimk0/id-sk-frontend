...
//
// Component names are lowercase, dash-separated strings (button, date-input),
// whilst macro names have a `idsk` prefix and are camel cased (idskButton,
// idskDateInput).
const govukComponentNameToMacroName = componentName => {
  const macroName = componentName
    .toLowerCase()
    .split('-')
    // capitalize each 'word'
...
exports.govukComponentNameToMacroName = govukComponentNameToMacroName
