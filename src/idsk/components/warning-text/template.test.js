...
describe('Warning text', () => {
  ...
  it('renders the default example with text', () => {
    ...
    const $component = $('.idsk-warning-text')
  ...
  it('renders the default example with assistive text', () => {
    ...
    const $assistiveText = $('.idsk-warning-text__assistive')
  ...
  it('hides the icon from screen readers using the aria-hidden attribute', () => {
    ...
    const $icon = $('.idsk-warning-text__icon')
    expect($icon.attr('aria-hidden')).toEqual('true')
  })

  it('renders classes', () => {
    const $ = render('warning-text', {
      classes: 'idsk-warning-text--custom-class',
      text: 'Warning text'
    })

    const $component = $('.idsk-warning-text')
    expect($component.hasClass('idsk-warning-text--custom-class')).toBeTruthy()
  })
